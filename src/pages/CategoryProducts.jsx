...
const CategoryProducts = () => {
  ...
  return (
    <div className="flex-1 p-8 w-full max-w-7xl mx-auto animate-fade-in-up">
      {/* Breadcrumbs */}
      <div className="mb-6 flex flex-wrap items-center text-sm text-muted-foreground gap-1.5">
      ...
      <div className="text-left mb-10">
        <h1 className="text-3xl font-bold mb-4 text-foreground">{category.name}</h1>
        <p className="text-foreground/80 text-sm md:text-base leading-relaxed text-justify">
