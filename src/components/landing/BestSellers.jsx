          ...
          {bestSellers.map((item) => (
            ...
            >
              ...
              <div className="mt-4 pt-1 flex items-center gap-2">
                <button className="flex-1 bg-slate-50 hover:bg-[#e65c00]/10 text-[#e65c00] border border-[#e65c00]/20 hover:border-[#e65c00]/40 text-xs font-extrabold py-2.5 rounded-xl transition-all duration-300 flex items-center justify-center space-x-1.5 hover:shadow-md cursor-pointer group/btn">
